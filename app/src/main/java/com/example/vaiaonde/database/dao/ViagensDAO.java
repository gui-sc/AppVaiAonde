    ...
    public ViagensModel selectById(long id){
        ...
        try{
            ...
            if (cursor.moveToFirst()) {
                ...
                viagem.setUsuariosModel(new UsuariosDAO(context).SelectById(cursor.getLong(5)));
                viagem.setUsuario(viagem.getUsuariosModel().getId());
                viagem.setGasolina(new GastoGasolinaDAO(context).SelectByViagem(viagem));
                viagem.setHospedagem(new GastoHospedagemDAO(context).SelectByViagem(viagem));
                viagem.setAereo(new GastoAereoDAO(context).SelectByViagem(viagem));
                viagem.getAereo().setViagem(null);
                viagem.setDiversos(new GastoDiversosDAO(context).SelectAll(viagem));
                viagem.setRefeicao(new GastoRefeicoesDAO(context).SelectByViagem(viagem));
                viagem.getRefeicao().setViagem(null);
            }
        } finally {
            Close();
        }
