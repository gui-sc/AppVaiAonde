...
import com.example.bancodedados.database.model.GastoDiversosModel;
...
public class GastoDiversosDAO extends AbstrataDao {
    ...
    public long Insert(GastoDiversosModel gastoDiversos) {
        ...
        try {
            ...
            values.put(GastoDiversosModel.COLUNA_VIAGEM_ID, gastoDiversos.getViagem_id());
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                while (!cursor.isAfterLast()) {
                    ...
                    gastoDiversos.setViagem_id(cursor.getLong(1));
